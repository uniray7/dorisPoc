# Doris cluster upstream — 1 FE + 1 BE, scheduled by Nomad onto the client whose
# meta.doris_cluster is "a".
#
...
#    carry meta.doris_cluster = "a" — the FE and BE groups must land on the same
